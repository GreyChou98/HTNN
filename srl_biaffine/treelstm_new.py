...
class LayerwiseTreeLSTM_new(nn.Module):
    def __init__(self, num_layers, feature_dim, span_net, dropout, comb_method='attn'):
        ...
        self.tree_layer_first = TreeLSTM(self.feature_dim, self.feature_dim, self.dropout, first_layer=True, comb_method=self.comb_method)
        self.tree_layers = nn.ModuleList([TreeLSTM(self.feature_dim, self.feature_dim, self.dropout, first_layer=False, comb_method=self.comb_method)
